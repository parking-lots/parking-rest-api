...
//        AvailablePeriod availablePeriod = new AvailablePeriod(LocalDate.of(2016, 11, 12), LocalDate.of(2016, 11, 20));
...
//        verify(lotsRepository, never()).freeOwnersParking(200, LocalDate.now(), LocalDate.now(), httpRequest);
//    }
//
//    @Test
